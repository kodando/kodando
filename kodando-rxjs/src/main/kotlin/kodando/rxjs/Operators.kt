...
@JsName("map")
inline fun <T, TResult> Subscribable
<T>.map(
    transformer: (T) -> TResult): Subscribable
<TResult> =
...
inline fun <T, TResult> Subscribable
<T>.flatMap(
    transformer: (T) -> Subscribable
    <TResult>): Subscribable
<TResult> =
...
@JsName("toArray")
inline fun <T> Subscribable
<T>.toArray(): Subscribable
<Array<T>> =
...
@JsName("filter")
inline fun <T> Subscribable
<T>.filter(filter: (T) -> Boolean): Subscribable
<T> =
...
inline fun <T> Subscribable
<T>.on(observer: Observer<T>): Subscribable
<T> =
...
<T>.on(
    ...
    complete: CompleteHandler? = null): Subscribable
<T> =
...
@JsName("retry")
inline fun <T> Subscribable
<T>.retry(times: Int): Subscribable
<T> =
...
inline fun <T> Subscribable
<T>.distinctUntilChanged(): Subscribable
<T> =
...
inline fun <T> Subscribable
<T>.distinctUntilChanged(mapper: (T) -> Any): Subscribable
<T> =
    this.asDynamic().distinctUntilChanged()


@JsName("distinctUntilChangedWithMapperAndEquality")
inline fun <T, MappedValue> Subscribable
<T>.distinctUntilChanged(mapper: (T) -> MappedValue, equalityHandler: (MappedValue, MappedValue) -> Boolean): Subscribable
<T> =
    this.asDynamic().distinctUntilChanged()
...
@JsName("toPromise")
inline fun <T> Subscribable
<T>.toPromise(): Promise<T> =
    this.asDynamic().toPromise()


@JsName("startWith")
inline fun <T> Subscribable
<T>.startWith(value: T): Subscribable
<T> =
...
@JsName("debounceTime")
inline fun <T> Subscribable
<T>.debounceTime(timeInMilliseconds: Int): Subscribable
<T> =
...
inline fun <T, TOther1> Subscribable
<T>.combineLatest(other: Subscribable
<TOther1>): Subscribable
<Array<Tuple2<T, TOther1>>> =
    this.asDynamic().combineLatest(other)


@JsName("combineLatest1AndProject")
fun <T, TOther, TResult> Subscribable
<T>.combineLatest(
    source1: Subscribable
    <TOther>,
    projection: (T, TOther) -> TResult): Subscribable
<TResult> =
    this.asDynamic().combineLatest(source1, projection)


@JsName("combineLatest2")
inline fun <T, T1, T2> Subscribable
<T>.combineLatest(source1: Subscribable
<T1>, source2: Subscribable
<T2>): Subscribable
<Array<Tuple3<T, T1, T2>>> =
    this.asDynamic().combineLatest(source1, source2)


@JsName("combineLatest2AndProject")
fun <T, T1, T2, TResult> Subscribable
<T>.combineLatest(
    source1: Subscribable
    <T1>,
    source2: Subscribable
    <T2>,
    projection: (T, T1, T2) -> TResult): Subscribable
<TResult> =
...
inline fun <T> Subscribable
<T>.combineLatest(vararg others: Subscribable
<*>): Subscribable
<Array<Any>> =
...
@JsName("concat")
inline fun <T> Subscribable
<T>.concat(vararg others: Subscribable
<T>): Subscribable
<T> =
...
@JsName("ofType")
inline fun <reified R> Subscribable
<*>.ofType(): Subscribable
<R> =
    this.map { it as? R }
        .filter { it != null }
