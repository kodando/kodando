...
class CreateComponentUsingObjectSpec : Spec() {

  private object CounterByClass : View<CounterByClass.Props> {
  ...
  init {
    describe("Component using a view object") {
